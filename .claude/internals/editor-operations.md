...
Repair, Walkability, Terrain from Image, Paint, TrigEdit, TrigScript, Stamp Library and scmjs.dev are default
plugins, all on but TrigEdit and scmjs.dev (`src/plugins/defaults.ts`); Melee Wizard and Section Explorer are installed from
Browse Plugins.
