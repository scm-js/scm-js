...
const TABLES = ["arr/units.dat", "arr/weapons.dat", "arr/upgrades.dat", "arr/techdata.dat", "arr/flingy.dat", "arr/sprites.dat", "arr/images.dat", "arr/images.tbl", "game/tunit.pcx", "scripts/iscript.bin"];
