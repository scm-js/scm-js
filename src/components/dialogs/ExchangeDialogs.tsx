  ...
  return (
    ...
    >
      ...
      <Group title="Into">
        ...
        {replace && target === "triggers" && script.block && <p className="hint" style={{ marginTop: 6 }}>Replacing removes the trigger script's generated block; the script stays in the archive and can be rebuilt from the Script Editor.</p>}
      </Group>
