...
export const PLAYER_GROUP_CHOICES: Choice[] = [
  ...
  { value: PlayerGroup.None, label: msg("None"), aliases: ["Player 13"] },
  { value: PlayerGroup.CurrentPlayer, label: msg("Current Player") },
  { value: PlayerGroup.Foes, label: msg("Foes") },
  { value: PlayerGroup.Allies, label: msg("Allies") },
  { value: PlayerGroup.NeutralPlayers, label: msg("Neutral Players") },
  { value: PlayerGroup.AllPlayers, label: msg("All Players"), aliases: ["All players"] },
  { value: PlayerGroup.Force1, label: msg("Force 1") },
  { value: PlayerGroup.Force2, label: msg("Force 2") },
  { value: PlayerGroup.Force3, label: msg("Force 3") },
  { value: PlayerGroup.Force4, label: msg("Force 4") },
  { value: PlayerGroup.Unused1, label: msg("Unused 1") },
  { value: PlayerGroup.Unused2, label: msg("Unused 2") },
  { value: PlayerGroup.Unused3, label: msg("Unused 3") },
  { value: PlayerGroup.Unused4, label: msg("Unused 4") },
  { value: PlayerGroup.NonAlliedVictoryPlayers, label: msg("Non Allied Victory Players"), aliases: ["Non AV Players"] },
];

export const UNIT_CLASS_CHOICES: Choice[] = [
  { value: UnitClass.Any, label: msg("Any unit"), aliases: ["Any Unit"] },
  { value: UnitClass.Men, label: msg("Men") },
  { value: UnitClass.Buildings, label: msg("Buildings") },
  { value: UnitClass.Factories, label: msg("Factories") },
];

export const CHOICES: Partial<Record<ArgKind, Choice[]>> = {
  player: PLAYER_GROUP_CHOICES,
  comparison: [
    { value: Comparison.AtLeast, label: msg("At least"), aliases: ["atleast", ">="] },
    { value: Comparison.AtMost, label: msg("At most"), aliases: ["atmost", "<="] },
    { value: Comparison.Exactly, label: msg("Exactly"), aliases: ["=="] },
  ],
  switchState: [
    { value: SwitchState.Set, label: "set", aliases: ["true"] },
    { value: SwitchState.Cleared, label: msg("not set"), aliases: ["cleared", "clear", "false"] },
  ],
  switchAction: [
    { value: SwitchAction.Set, label: "set" },
    { value: SwitchAction.Clear, label: msg("clear"), aliases: ["cleared"] },
    { value: SwitchAction.Toggle, label: msg("toggle") },
    { value: SwitchAction.Randomize, label: msg("randomize"), aliases: ["random", "randomise"] },
  ],
  modifier: [
    { value: SetModifier.SetTo, label: msg("Set To"), aliases: ["setto", "set"] },
    { value: SetModifier.Add, label: msg("Add") },
    { value: SetModifier.Subtract, label: msg("Subtract"), aliases: ["sub"] },
  ],
  unitState: [
    { value: UnitState.Enable, label: msg("enable"), aliases: ["enabled"] },
    { value: UnitState.Disable, label: msg("disable"), aliases: ["disabled"] },
    { value: UnitState.Toggle, label: msg("toggle") },
  ],
  order: [
    { value: Order.Move, label: msg("move") },
    { value: Order.Patrol, label: msg("patrol") },
    { value: Order.Attack, label: msg("attack") },
  ],
  alliance: [
    { value: AllianceStatus.Enemy, label: msg("Enemy") },
    { value: AllianceStatus.Ally, label: msg("Ally"), aliases: ["Allied"] },
    { value: AllianceStatus.AlliedVictory, label: msg("Allied Victory") },
  ],
  resource: [
    { value: ResourceType.Ore, label: "ore", aliases: ["minerals"] },
    { value: ResourceType.Gas, label: "gas" },
    { value: ResourceType.OreAndGas, label: msg("ore and gas"), aliases: ["both"] },
  ],
  score: [
    { value: ScoreType.Total, label: msg("Total") },
    { value: ScoreType.Units, label: msg("Units") },
    { value: ScoreType.Buildings, label: msg("Buildings") },
    { value: ScoreType.UnitsAndBuildings, label: msg("Units and buildings") },
    { value: ScoreType.Kills, label: msg("Kills") },
    { value: ScoreType.Razings, label: msg("Razings") },
    { value: ScoreType.KillsAndRazings, label: msg("Kills and razings") },
    { value: ScoreType.Custom, label: msg("Custom") },
  ],
  textFlags: [
    { value: 0, label: msg("Don't Always Display"), aliases: ["Dont Always Display", "Never Display"] },
    { value: 4, label: msg("Always Display") },
  ],
};
