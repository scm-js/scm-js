...
export const TEXT_CODES: readonly TextCode[] = [
  x(0x01, msg("Mimic (keeps the current colour)"), "mimic"),
  c(0x02, msg("Cyan"), "#b8b8e8"),
  c(0x03, msg("Yellow"), "#dcdc3c"),
  c(0x04, msg("White"), "#ffffff"),
  c(0x05, msg("Grey"), "#847474"),
  c(0x06, msg("Red"), "#c81818"),
  c(0x07, msg("Green"), "#10fc18"),
  c(0x08, msg("Red — player 1"), "#f40404", 1),
  x(0x09, msg("Tab"), "space"),
  x(0x0a, msg("Newline"), "space"),
  x(0x0b, msg("Invisible"), "invisible"),
  x(0x0c, msg("Remove beyond (newline in the small font)"), "clip"),
  x(0x0d, msg("Carriage return"), "space"),
  c(0x0e, msg("Blue — player 2"), "#0c48cc", 2),
  c(0x0f, msg("Teal — player 3"), "#2cb494", 3),
  c(0x10, msg("Purple — player 4"), "#88409c", 4),
  c(0x11, msg("Orange — player 5"), "#f88c14", 5),
  x(0x12, msg("Right align"), "align"),
  x(0x13, msg("Centre align"), "align"),
  x(0x14, msg("Invisible"), "invisible"),
  c(0x15, msg("Brown — player 6"), "#703014", 6),
  c(0x16, msg("White — player 7"), "#cce0d0", 7),
  c(0x17, msg("Yellow — player 8"), "#fcfc38", 8),
  c(0x18, msg("Green — player 9"), "#088008", 9),
  c(0x19, msg("Brighter yellow — player 10"), "#fcfc7c", 10),
  x(0x1a, msg("Nothing"), "nothing"),
  c(0x1b, msg("Pinkish — player 11"), "#ecc4b0", 11),
  c(0x1c, msg("Dark cyan — player 12"), "#4068d4", 12),
  c(0x1d, msg("Grey-green"), "#74a47c"),
  c(0x1e, msg("Blue-grey"), "#9090b8"),
  c(0x1f, msg("Turquoise"), "#00e4fc"),
];
