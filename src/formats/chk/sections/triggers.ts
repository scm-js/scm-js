...
/**
 * Unit ids beyond units.dat that conditions and actions accept. 228 is "None"; the classes
 * start at 229 — a melee map's own defeat trigger is "commands at most 0 of 231", Buildings.
 */
