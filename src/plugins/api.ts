...
import type { TriggerRef, TriggerRefAccess, TriggerRefKind, TriggerRefs } from "../editor/triggerRefs";
...
import type { SyncOp } from "../editor/sync";
...
export type {
  ...
  TriggerRef, TriggerRefs, TriggerRefKind, TriggerRefAccess,
...
export type GoTo =
  ...
  | { kind: "trigger"; index: number; briefing?: boolean };
